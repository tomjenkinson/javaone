...
java $(getDebugArgs $PORT) -jar narayana-full-5.7.0.Final/rts/lra/lra-coordinator-swarm.jar -Dswarm.http.port=8080 -Dswarm.transactions.object-store-path=../parent &
ID1=$!
((PORT++))
java $(getDebugArgs $PORT) -jar narayana-full-5.7.0.Final/rts/lra/lra-coordinator-swarm.jar -Dswarm.http.port=8081 -Dswarm.transactions.object-store-path=../subordinate &
ID2=$!
((PORT++))
